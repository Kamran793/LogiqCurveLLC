...
export default function SignUp() {
  ...
  const inputStyles =
    "h-14 w-full bg-white text-black border-gray-200 focus:border-zinc-900 focus:ring-zinc-900 rounded-xl placeholder:text-gray-500 px-4 [&:-webkit-autofill]:!bg-white [&:-webkit-autofill]:!text-black [&:-webkit-autofill]:shadow-[inset_0_0_0_9999px_white]";
      ...
      <div className="min-h-screen w-full grid place-items-center relative">
        ...
        <div className="w-full px-4 sm:px-0 sm:max-w-[400px] -mt-16">
          {!showPassword ? (
            ...
            <form className="w-full space-y-6" action={signUpAction}>
              <div className="space-y-2 text-center">
                <h1 className="text-[32px] font-normal tracking-tight text-center">
                  Create a password
                </h1>
          ...
          <div className="text-center text-sm">
            ...
            <Link
              href="/sign-in"
              className="text-zinc-900 hover:underline font-normal"
            >
              Sign in
            </Link>
          </div>
